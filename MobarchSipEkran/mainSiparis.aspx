    ...
    <section class="mt-3">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <div>
                <div class="section-title">
                    🧾 Müşteri Siparişi
                <span class="badge badge-pill bg-light text-secondary border">Online sipariş giriş ekranı
                </span>
                </div>
        ...
        <div class="row g-3 align-items-start">
            ...
            <div class="col-lg-8">
                ...
                <div class="card shadow-soft mb-3">
                    <div class="card-header  text-white d-flex justify-content-between align-items-center" style="background-color: #3F4C6B; border-color: #E4E8F0">
                        <span class="card-header-small fw-bold">Genel Bilgiler
                        </span>
                        <span class="badge bg-light " style="color: #3F4C6B">Sipariş başlığı
                        </span>
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                ...
                <!-- Stok Ekle -->
                <div class="card shadow-soft mb-3">
                    <div class="card-header  text-white d-flex justify-content-between align-items-center" style="background-color: #5A67D8; border-color: #E4E8F0">
                        <span class="card-header-small fw-bold">Ürün Seç
                        </span>
                        <small class="text-white-50">Sipariş vereceğin ürünü seç</small>
                    </div>
                    <div class="card-body">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                <asp:LinkButton ID="btnEkle" runat="server" Text="Ürün Ekleme"
                                    ...
                                    CssClass="btn btnstokekle  text-white btn-sm mt-2 w-100 "
            ...
            <div class="col-lg-4">
                <asp:UpdatePanel ID="upTotals" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <!-- Hesap Bilgisi -->
                        <div class="card shadow-soft mb-3">
                            <div class="card-header text-white d-flex justify-content-between align-items-center" style="background-color: #B23A48; border-color: #E4E8F0">
                                <span class="card-header-small text-white fw-bold">HESAP BİLGİSİ</span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:Label ID="lblRiskLimiti" runat="server"
                                        CssClass="form-control form-control-sm mb-2 bg-light text-end" Style="color: #D64550" />
                                </div>
                        ...
                        <div class="card shadow-soft">
                            <div class="card-header  text-white d-flex justify-content-between align-items-center" style="border-color: #38A169; background-color: #2F855A">
                                <span class="card-header-small fw-bold">TOPLAM HESAPLAR</span>
                            ...
                            <div class="card-body">
                                ...
                                <asp:TextBox ID="txtGenelToplam" runat="server" ReadOnly="true"
                                    CssClass="form-control form-control-sm text-end fw-bold border-2 border-success" Style="color: #1F5C3F" />
                    ...
                    <ContentTemplate>
                        ...
                        <div class="card shadow-soft mb-3">
                            <div class="card-header bg-light d-flex justify-content-between align-items-center">
                                <span class="card-header-small text-secondary">SATIR DETAYLARI
                                </span>
                                ...
                                <div class="grid-wrap">
                                    ...
                                    <asp:GridView ID="gvStoklar" runat="server" AutoGenerateColumns="False"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="BirimMetin" HeaderText="Birim" 
        ...
        <div class="row mt-3">
            <div class="col-12 text-end">
                <asp:Button ID="btnKaydet" runat="server" Text="Kaydet" Style="background-color: #5A67D8; border-color: #E4E8F0"
                    CssClass="btn text-white  me-2" OnClick="btnKaydet_Click" />
