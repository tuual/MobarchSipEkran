...
<i class="bi bi-check-all"></i> Tamamla
                </asp:LinkButton>
                    </div>
                ...
                <asp:UpdatePanel ID="upStok" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        ...
                        <asp:GridView ID="gv" runat="server"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="Seçili" ControlStyle-Width="125px" ItemStyle-CssClass="text-center" HeaderStyle-CssClass="text-center" ItemStyle-BackColor="">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="cbStok" runat="server" Width="10px" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                        ...
                        <asp:Label CssClass="text-danger">Açık Bakiye: </asp:Label>
                        <asp:Label ID="lbKullLimit" runat="server"></asp:Label>
