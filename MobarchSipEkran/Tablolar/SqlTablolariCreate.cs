...
namespace MobarchSipEkran.Tablolar
{
    public class SqlTablolariCreate
    {
        public SqlTablolariCreate()
        {
            ...
            string tablo3 = "CREATE TABLE tWebSiparisDetayTemp(SessionID nvarchar(50),StokKodu NVARCHAR(50),Miktar DECIMAL(18,2),KayitTarihi datetime,Fiyat Decimal(18,2),Birim int,NetFiyat Decimal(18,2))";
            string tablo4 = "CREATE TABLE [dbo].[tWebSiparis]([SessionId] [nvarchar](100) NULL ,[StokKodu] [nvarchar](50) NULL,[Miktar] [decimal](18, 2) NULL,[KayitTarihi] [datetime] NULL,[Fiyat] [decimal](18, 2) NULL,Birim int,NetFiyat Decimal(18,2)) ON [PRIMARY]";
        } 
    }
}